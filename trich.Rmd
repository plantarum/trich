...
sumTable %>%
  ...
  kable(caption = "Populations sampled. The first two letters of the Population Code indicate the US state or Canadian province. N: total samples per population (samples with all 11 loci scored in parentheses). Ap: private alleles. Ar: mean allelic richness per locus. mlg: multilocus genotypes. eMLG: multilocus genotypes in rarefied samples of 10 individuals. Hs: gene diversity. Ho: observed heterozygosity.") 
```
...
homogenizing genetic diversity in peripheral populations. If that were the
case, we would expect to see lower among-population variation (F_ST), and
relatively higher within-population variation (F_IS).
